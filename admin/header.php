...
<!-- Sidebar -->
    <div class="bg-white" id="sidebar-wrapper">
        ...
        <div class="list-group list-group-flush my-3">
            ...
            <i class="fa-solid fa-user me-3"></i>Student</a>
            <a href="teachers.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold">
            <i class="fa-solid fa-person-chalkboard fa-xl me-3"></i>teacher</a>
            <a href="dept.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold">
            <i class="fa-solid fa-house fa-lg me-3"></i>dept</a>
            <a href="classe.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold">
            <i class="fa-solid fa-chalkboard-user me-3"></i>classe</a>
