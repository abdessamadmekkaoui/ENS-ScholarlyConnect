<?php
                ...
                $id = $_GET['id'];
                if(isset($_POST['addabs']) //&& isset($_POST['nheur']) && isset($_POST['date'])
                ){
                
                $date = mysqli_real_escape_string($conn, $_POST['date']);
                $heur = mysqli_real_escape_string($conn, $_POST['nheur']);
                $insert = mysqli_query($conn, "INSERT INTO `teachabs`(nh, jour, idteach) VALUES('$heur', '$date', '$id')") or die('query failed');
                                if($insert){
                ...
                <form action="" method="post" enctype="multipart/form-data">                            
                            ...
                            <div class="inputBox">
                            <span>nombre d'heur :</span>
                            <input type="number" name="nheur" class="box"></div>
                            <div class="inputBox">
                            <span>date :</span>
                            <input type="date" name="date" class="box">
                            </div>
                            </div>
                            <input type="submit" value="add absence" name="addabs" class="btn">
