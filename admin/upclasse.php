...
<div class="d-flex" id="wrapper">
    ...
    <div class="update-profile">
        ...
        <?php
            $select = mysqli_query($conn, "SELECT classe.id,classe.name as name,classe.dept,dept.id,dept.name as dept FROM classe JOIN dept ON classe.dept=dept.id WHERE classe.id = '$id'") or die('query failed');
            if(mysqli_num_rows($select) > 0){
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="flex">
                ...
                <div class="inputBox">
                    <span>dept name :</span>
                    <input type="text" name="name" value="<?php echo $fetch['dept']; ?>" class="box">
                </div>
               
            </div>
            <input type="submit" value="update classe" name="update_profile" class="btn">
