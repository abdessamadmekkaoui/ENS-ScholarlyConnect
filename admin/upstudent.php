      <?php
            ...
            if(isset($_POST['update_profile'])){
               ...
               $update_loca = mysqli_real_escape_string($conn, $_POST['update_loca']);
               $update_email = mysqli_real_escape_string($conn, $_POST['update_email']);

               mysqli_query($conn, "UPDATE `student` SET location = '$update_loca', email = '$update_email' WHERE id = '$user_id'") or die('query failed');
               ...
               if(!empty($old_pass) || !empty($new_pass) || !empty($confirm_pass)){
                  if($new_pass != $confirm_pass){
                     ...
                     mysqli_query($conn, "UPDATE `student` SET password = '$confirm_pass' WHERE id = '$user_id'") or die('query failed');
               ...
               if(!empty($update_image)){
                  if($update_image_size > 2000000){
                     ...
                     $image_update_query = mysqli_query($conn, "UPDATE `student` SET image = '$update_image' WHERE id = '$user_id'") or die('query failed');
...
<div class="update-profile">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex">
         <div class="inputBox">
            <span>location :</span>
            <input type="text" name="update_loca" value="<?php echo $fetch['location']; ?>" class="box">
            <span>your email :</span>
            <input type="text" name="update_email" value="<?php echo $fetch['email']; ?>" class="box"readonly>
            <span>conferm email :</span>
            <input type="text" name="update_email" placeholder="enter your new email" class="box">
         </div>
         <div class="inputBox">
            <span>old password :</span>
            <input type="text" name="old_pass" value="<?php echo $fetch['password']; ?>" class="box" readonly>
            <span>new password :</span>
            <input type="password" name="new_pass" placeholder="enter new password" class="box">
            <span>confirm password :</span>
            <input type="password" name="confirm_pass" placeholder="confirm new password" class="box">
