...
<div class="update-profile">
   ...
   <form >
      ...
      <div class="flex">
         <div class="inputBox">
            <span>name :</span>
            <input type="text" name="name" value="<?php echo $fetch['name']; ?>" class="box" readonly>
            <span>your email :</span>
            <input type="text" name="email" value="<?php echo $fetch['email']; ?>" class="box" readonly>
         </div>
         <div class="inputBox">
            <span>phone :</span>
            <input type="text" name="phone" value="<?php echo $fetch['sphone']; ?>" class="box" readonly>
            <span>location :</span>
            <input type="text" name="loca" value="<?php echo $fetch['location']; ?>" class="box" readonly>
         </div>
      </div>
      <a href="upstudent.php?id=<?php echo $fetch['id'];?>" class="btn">update</a>
