                ...
                <div class="row g-3 my-2">
                    <div class="col-md-3">
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            <div>
                                <h3 class="fs-2">Absences:</h3>
                                <p class="fs-5 ms-5 " style="color: red;">
                                   <?php $select = mysqli_query($conn, "SELECT sum(absence.nbheur) as somm FROM absence JOIN sturent on absence.idstudent=sturent.idstudent where sturent.idparent='$user_id'") or die('query failed');
                    ...
                    <div class="col-md-3">
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            <div>
                                <h3 class="fs-2">Average notes:</h3>
                                
                                <p class="fs-5 ms-5 " style="color: red;">
                                   <?php $select = mysqli_query($conn, "SELECT avg(note)as mam FROM notes JOIN sturent on notes.idstudent=sturent.idstudent where sturent.idparent='$user_id'") or die('query failed');
                                    $row = mysqli_fetch_assoc($select);
                                    echo $row['mam']."/20";?>
                                </p>
                            </div>
                    ...
                    <div class="col-md-3">
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            <div>
                                ...
                                <p class="fs-5 ms-5 " style="color: red;">
                                   <?php $select = mysqli_query($conn, "SELECT MAX(note) FROM notes JOIN sturent on notes.idstudent=sturent.idstudent where sturent.idparent='$user_id'") or die('query failed');
                                    $row = mysqli_fetch_assoc($select);
                                    echo $row['MAX(note)']."/20";?>
                                </p>
                            </div>
                    ...
                    <div class="col-md-3">
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            <div>
                                ...
                                <p class="fs-5 ms-5 " style="color: red;">
                                   <?php $select = mysqli_query($conn, "SELECT MIN(note) FROM notes JOIN sturent on notes.idstudent=sturent.idstudent where sturent.idparent='$user_id'") or die('query failed');
                                    $row = mysqli_fetch_assoc($select);
                                    echo $row['MIN(note)']."/20";?>
                                </p>
                            </div>
