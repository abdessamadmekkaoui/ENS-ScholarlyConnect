                        ...
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            <div>
                                ...
                                <p class="fs-5 ms-5 " style="color: red;">
                                   <?php $select = mysqli_query($conn, "SELECT sum(absence.nbheur) as somm FROM absence where absence.idstudent=$user_id") or die('query failed');
                    ...
                    <div class="col-md-3">
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            <div>
                                ...
                                <p class="fs-5 ms-5 " style="color: red;">
                                   <?php $select = mysqli_query($conn, "SELECT avg(note)as mam FROM notes where notes.idstudent=$user_id") or die('query failed');
                                    $row = mysqli_fetch_assoc($select);
                                    echo $row['mam']."/20";?>
                                </p>
                            </div>
                    ...
                    <div class="col-md-3">
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            <div>
                                ...
                                <p class="fs-5 ms-5 " style="color: red;">
                                   <?php $select = mysqli_query($conn, "SELECT MAX(note) FROM notes where idstudent=$user_id") or die('query failed');
                                    $row = mysqli_fetch_assoc($select);
                    ...
                    <div class="col-md-3">
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            <div>
                                ...
                                <p class="fs-5 ms-5 " style="color: red;">
                                   <?php $select = mysqli_query($conn, "SELECT MIN(note) FROM notes where idstudent=$user_id") or die('query failed');
                                    $row = mysqli_fetch_assoc($select);
