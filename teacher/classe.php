                        ...
                        <table class="table bg-white rounded shadow-sm  table-hover">
                         <thead>
                                ...
                                <tbody>
                                    <?php
                                        $i = 1;
                                        $qry = $conn->query("SELECT classe.id as idd ,classe.name as name ,dept.name as dept ,teacher.id, teachclasse.classeid, teachclasse.teachid FROM classe 
                                        JOIN dept ON classe.dept=dept.id
                                        JOIN teachclasse ON  teachclasse.classeid= classe.id
                                        JOIN teacher ON teacher.id=teachclasse.teachid
                                        where teacher.id= $user_id");
                                        while($row= $qry->fetch_assoc()):
                                    ?>
                                    <tr>
                                        <td class="text-center"><?php echo $i++ ?></td>
                                        <td class=""><b><?php echo $row['idd'] ?></b></td>
                                        <td><?php echo $row['dept']?></td>
                                        <td><?php echo ucwords($row['name']) ?></td>
                                        
                                        <td><a href="addnotes.php?id=<?php echo $row['idd'] ?>" class="btn btn-success btn-flat ">
                                                <i class="fas fa-add"></i>
                                            </a>
                                        </td>
                                        <td><a href="classeabs.php?id=<?php echo $row['idd'] ?>" class="btn btn-success btn-flat ">
                                                <i class="fas fa-add"></i>
                                            </a>
                                        </td>
                                    </tr>	
