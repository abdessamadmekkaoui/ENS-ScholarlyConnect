        ...
        <?php
            ...
            if(isset($_POST['mama'])){
                ...
                $nbheur = mysqli_real_escape_string($conn, $_POST['nbheur']);
                $idst = mysqli_real_escape_string($conn, $_POST['student_id']);
                
                        $insert = mysqli_query($conn, "INSERT INTO `absence`(nbheur, jour, idstudent,teacher) 
                        VALUES('$nbheur','$date', '$idst','$user_id')") or die('query failed');
                                    echo "<script>alert('absence inserted successfully ');</script>";
...
<?php include 'header.php'?>
                                ...
                                <?php
                                    ...
                                    if(!empty($update_image)){
                                        if($update_image_size > 2000000){
                                            ...
                                            $image_update_query = mysqli_query($conn, "UPDATE `taecher` SET image = '$update_image' WHERE id = '$user_id'") or die('query failed');
    ...
    <thead>
        <tr>
            ...
            <th scope="col">jour<button class="btn btn-sm btn-link" onclick="sortTable(6)"><i class="fas fa-sort"></i></button></th>
            <th scope="col">nb-heur<button class="btn btn-sm btn-link" onclick="sortTable(7)"><i class="fas fa-sort"></i></button></th>
            ...
            <tr>
                ...
                <td>
                    <form action="" method="post">
                        ...
                        <td><input type="number" name="nbheur"></td>
                        <td>
                        <input type="submit" name="mama" class="btn btn-success" value="Validate">
                    </form>
                </td>
            </tr>
        <?php endwhile; ?>
